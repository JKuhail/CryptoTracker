...
package com.jkuhail.cryptotracker.core.navigation
...
import com.jkuhail.cryptotracker.crypto.presentation.coin_list.CoinListAction
...
@Composable
fun AdaptiveCoinListDetailsPane(
     ...
     *
     * 'viewModel::onAction' equals to '{ action -> viewModel.onAction(action)}'
     */
